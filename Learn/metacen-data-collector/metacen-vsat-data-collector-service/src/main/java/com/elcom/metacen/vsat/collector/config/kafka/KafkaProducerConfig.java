package com.elcom.metacen.vsat.collector.config.kafka;
...
public class KafkaProducerConfig {
    ...
    @Value("${kafka.bootstrap.servers.metacen}")
    ...
    public ProducerFactory<String, String> producerFactory() {
        ...
        configProps.put(ProducerConfig.REQUEST_TIMEOUT_MS_CONFIG, 180000); // default 30000 (30s)
        configProps.put(ProducerConfig.BATCH_SIZE_CONFIG, 8192); // default 16384 (bytes)
